...
<h1  style="font-size: 50px; text-align: center; font-family:> Impact;">Quiénes Somos</h1>
		<p>Somos un casal donde disponemos de diferentes recursos para nuestros usuarios.</p>
	</div>
	<div class="cuadrotexto">
<h1  style="font-size: 50px; text-align: center; font-family:> Impact;">Dónde estamos</h1>
